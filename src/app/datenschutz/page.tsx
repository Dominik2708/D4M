...
export const metadata = { title: 'Datenschutzerklärung — D4M' };
        ...
        <div className="max-w-5xl mx-auto px-4">
          <article className="prose lg:prose-lg mx-auto bg-white/95 p-8 rounded-xl shadow-sm border border-gray-100">
            ...
            <p>
              ...
              B. Device‑Fingerprinting) umfasst. Die Einwilligung ist jederzeit widerrufbar.
            </p>
            ...
            <p>
              Wenn die Datenverarbeitung aufgrund von Art. 6 Abs. 1 lit. e oder f DSGVO erfolgt,
            ...
            <p>
              ...
              Widerspruch einlegen, werden Ihre personenbezogenen Daten anschließend nicht mehr zum
            ...
            <p>
              ...
              Zugriff auf Informationen in Ihr Endgerät (z. B. Device‑Fingerprinting) umfasst. Die
              Einwilligung ist jederzeit widerrufbar.
            </p>
            <p>
            ...
            <p>
              ...
              den USA, das die Einhaltung europäischer Datenschutzstandards bei Datenverarbeitungen
              in den USA gewährleisten soll. Weitere Informationen hierzu erhalten Sie beim Anbieter
              unter:{' '}
              <a
