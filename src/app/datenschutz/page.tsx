      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 pt-24 pb-12 overflow-x-hidden">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">Informationen gemäß DSGVO</p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
                <article className="prose prose-gray max-w-none [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-gray-900 [&_h2]:mt-8 [&_h2]:mb-4 [&_h2]:pb-2 [&_h2]:border-b [&_h2]:border-gray-200 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-gray-800 [&_h3]:mt-6 [&_h3]:mb-3 [&_h4]:font-semibold [&_h4]:text-gray-700 [&_h4]:mt-4 [&_h4]:mb-2 [&_p]:text-gray-600 [&_p]:leading-relaxed [&_p]:mb-4 [&_ul]:text-gray-600 [&_ul]:space-y-2 [&_li]:leading-relaxed [&_a]:text-blue-600 [&_a]:hover:text-blue-800 [&_a]:hover:underline [&_a]:break-all">
                  ...
                  <p>
                    ...
                    werden können, werden die übermittelten Daten auch für Vertragsangebote,
                  ...
                  <p>
                    Wenn die Datenverarbeitung aufgrund von Art. 6 Abs. 1 lit. e oder f DSGVO
                  ...
                  <p>
                    ...
                    Verbindung steht. Wenn Sie Widerspruch einlegen, werden Ihre personenbezogenen
                    Daten anschließend nicht mehr zum Zwecke der Direktwerbung verwendet
                  ...
                  <p>
                    ...
                    Limited („Google“), Gordon House, Barrow Street, Dublin 4, Irland. Mit Hilfe
                    dieses Dienstes können wir Kartenmaterial auf unserer Website einbinden.
                  </p>
                  <p>
                    ...
                    zum Zwecke der einheitlichen Darstellung der Schriftarten Google Fonts
                    verwenden. Beim Aufruf von Google Maps lädt Ihr Browser die benötigten Web Fonts
                  ...
                  <p>
                    ...
                    Cookies oder den Zugriff auf Informationen in Ihr Endgerät (z. B.
                  ...
                  <p>
                    ...
                    und den USA, das die Einhaltung europäischer Datenschutzstandards bei
                    Datenverarbeitungen in den USA gewährleisten soll. Weitere Informationen hierzu
                    erhalten Sie beim Anbieter unter:{' '}
                    <a
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Rechtliche Hinweise</h3>
